...
async def generate_session(bot: Client, msg: Message, telethon=False, is_bot: bool = False):
    ...
    if not is_bot:
        t = "» 𝘼𝙥𝙣𝙖 𝙥𝙝𝙤𝙣𝙚 𝙣𝙪𝙢𝙗𝙚𝙧 𝙙𝙖𝙖𝙡𝙚 𝙘𝙤𝙪𝙣𝙩𝙧𝙮 𝙘𝙤𝙙𝙚 𝙠𝙚 𝙨𝙖𝙖𝙩𝙝 .\n𝙆𝙪𝙘𝙝 𝙞𝙨𝙨 𝙩𝙖𝙧𝙖𝙝 𝙨𝙚 : `+910000000000`'"
    else:
        t = "𝘼𝙥𝙣𝙖 𝙗𝙤𝙩 𝙩𝙤𝙠𝙚𝙣 𝙗𝙝𝙚𝙟𝙚.\n𝙆𝙪𝙘𝙝 𝙞𝙨𝙨 𝙩𝙖𝙧𝙖𝙝 𝙨𝙚 : `5432198765:abcdanonymousterabaaplol`'"
    phone_number_msg = await bot.ask(user_id, t, filters=filters.text)
    if await cancelled(phone_number_msg):
        return
    phone_number = phone_number_msg.text
    if not is_bot:
        await msg.reply("» 𝘼𝙖𝙥𝙠𝙚 𝙙𝙞𝙮𝙚 𝙝𝙪𝙚 𝙣𝙪𝙢𝙗𝙚𝙧 𝙥𝙚𝙧 𝙤𝙩𝙥 𝙗𝙝𝙚𝙟𝙖 𝙟𝙖 𝙧𝙖𝙝𝙖 𝙝𝙖𝙞...")
    else:
        await msg.reply("» 𝘼𝙖𝙥𝙠𝙚 𝙙𝙞𝙮𝙚 𝙝𝙪𝙚 𝙗𝙤𝙩 𝙩𝙤𝙠𝙚𝙣 𝙨𝙚 𝙗𝙤𝙩 𝙡𝙤𝙜 𝙞𝙣 𝙠𝙞𝙮𝙖 𝙟𝙖 𝙧𝙖𝙝𝙖 𝙬𝙖𝙞𝙩 𝙠𝙧𝙚...")
    ...
    text = f"**ᴛʜɪs ɪs ʏᴏᴜʀ {ty} sᴛʀɪɴɢ sᴇssɪᴏɴ** \n\n`{string_session}` \n\n**ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ :** @ChampuStringBot\n🍒 **ɴᴏᴛᴇ :** ᴅᴏɴ'ᴛ sʜᴀʀᴇ ɪᴛ ᴡɪᴛʜ ʏᴏᴜʀ ɢɪʀʟғʀɪᴇɴᴅ 🍑 ᴀɴᴅ ᴅᴏɴ'ᴛ ғᴏʀɢᴇᴛ ᴛᴏ ᴊᴏɪɴ @Champu_Links 🥺"
    try:
        if not is_bot:
